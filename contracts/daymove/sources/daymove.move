...
// Convert to UTC
public fun to_utc(self: &OffsetDateTime): OffsetDateTime {
    to_offset(self, &utc_offset::utc())
}

// Convert to JST
public fun to_jst(self: &OffsetDateTime): OffsetDateTime {
    to_offset(self, &utc_offset::jst())
}

// Convert to EST
public fun to_est(self: &OffsetDateTime): OffsetDateTime {
    to_offset(self, &utc_offset::est())
}

// Convert to CET
public fun to_cet(self: &OffsetDateTime): OffsetDateTime {
    to_offset(self, &utc_offset::cet())
}
