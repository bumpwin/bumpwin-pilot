...
export function isString(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::string::String`; }
...
export class String implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::string::String`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = String.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::string::String`; readonly $typeArgs: []; readonly $isPhantom = String.$isPhantom;

 readonly bytes: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: StringFields, ) { this.$fullTypeName = composeSuiType( String.$typeName, ...typeArgs ) as `${typeof PKG_V16}::string::String`; this.$typeArgs = typeArgs;

 this.bytes = fields.bytes; }

 static reified( ): StringReified { return { typeName: String.$typeName, fullTypeName: composeSuiType( String.$typeName, ...[] ) as `${typeof PKG_V16}::string::String`, typeArgs: [ ] as [], isPhantom: String.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => String.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => String.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => String.fromBcs( data, ), bcs: String.bcs, fromJSONField: (field: any) => String.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => String.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => String.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => String.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => String.fetch( client, id, ), new: ( fields: StringFields, ) => { return new String( [], fields ) }, kind: "StructClassReified", } }
