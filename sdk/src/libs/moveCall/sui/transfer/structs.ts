...
export class Receiving<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::transfer::Receiving<${PhantomToTypeStr<T>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ReceivingFields<T>) {
    this.$fullTypeName = composeSuiType(
      Receiving.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer::Receiving<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Receiving.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::transfer::Receiving<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
