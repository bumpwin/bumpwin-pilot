...
export function isObjectBag(type: string): boolean {
  ...
  return type === `${PKG_V1}::object_bag::ObjectBag`;
}
...
export class ObjectBag implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::object_bag::ObjectBag`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ObjectBag.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::object_bag::ObjectBag`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ObjectBagFields) {
    this.$fullTypeName = composeSuiType(
      ObjectBag.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::object_bag::ObjectBag`;
