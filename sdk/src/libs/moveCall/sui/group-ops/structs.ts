...
export class Element<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::group_ops::Element<${PhantomToTypeStr<T>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ElementFields<T>) {
    this.$fullTypeName = composeSuiType(
      Element.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::group_ops::Element<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Element.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::group_ops::Element<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
