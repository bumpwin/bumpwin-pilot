...
export function isCurve(type: string): boolean {
  ...
  return type === `${PKG_V1}::groth16::Curve`;
}
...
export class Curve implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::groth16::Curve`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Curve.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::groth16::Curve`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: CurveFields) {
    this.$fullTypeName = composeSuiType(
      Curve.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::groth16::Curve`;
  ...
  static reified(): CurveReified {
    return {
      ...
      fullTypeName: composeSuiType(Curve.$typeName, ...[]) as `${typeof PKG_V1}::groth16::Curve`,
      typeArgs: [] as [],
...
export function isPreparedVerifyingKey(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::groth16::PreparedVerifyingKey`;
}
...
export class PreparedVerifyingKey implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::groth16::PreparedVerifyingKey`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = PreparedVerifyingKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::groth16::PreparedVerifyingKey`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PreparedVerifyingKeyFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::groth16::PreparedVerifyingKey`;
    this.$typeArgs = typeArgs;
...
export function isPublicProofInputs(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::groth16::PublicProofInputs`;
}
...
export class PublicProofInputs implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::groth16::PublicProofInputs`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = PublicProofInputs.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::groth16::PublicProofInputs`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PublicProofInputsFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::groth16::PublicProofInputs`;
    this.$typeArgs = typeArgs;
...
export function isProofPoints(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::groth16::ProofPoints`;
}
...
export class ProofPoints implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::groth16::ProofPoints`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ProofPoints.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::groth16::ProofPoints`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ProofPointsFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::groth16::ProofPoints`;
    this.$typeArgs = typeArgs;
