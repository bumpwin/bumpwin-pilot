...
export function isVerifiedIssuer(type: string): boolean {
  ...
  return type === `${PKG_V1}::zklogin_verified_issuer::VerifiedIssuer`;
}
...
export class VerifiedIssuer implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::zklogin_verified_issuer::VerifiedIssuer`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = VerifiedIssuer.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::zklogin_verified_issuer::VerifiedIssuer`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: VerifiedIssuerFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::zklogin_verified_issuer::VerifiedIssuer`;
