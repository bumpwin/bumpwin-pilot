  ...
  implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::table::Table<${PhantomToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Table.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::table::Table<${PhantomToTypeStr<K>}, ${PhantomToTypeStr<V>}>`;
  ...
  >(K: K, V: V): TableReified<ToPhantomTypeArgument<K>, ToPhantomTypeArgument<V>> {
    return {
      ...
      ) as `${typeof PKG_V1}::table::Table<${PhantomToTypeStr<ToPhantomTypeArgument<K>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<V>>}>`,
