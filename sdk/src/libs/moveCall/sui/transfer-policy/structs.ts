...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferRequest<${PhantomToTypeStr<T>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferRequestFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferRequest<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferRequest.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicy.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyCapFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicyCap.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyCreatedFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicyCreated.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyDestroyedFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicyDestroyed.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RuleKeyFields<T>) {
    this.$fullTypeName = composeSuiType(
      RuleKey.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        RuleKey.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::transfer_policy::RuleKey<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
