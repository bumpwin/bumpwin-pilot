...
export class Supply<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::balance::Supply<${PhantomToTypeStr<T>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: SupplyFields<T>) {
    this.$fullTypeName = composeSuiType(
      Supply.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::balance::Supply<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Supply.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::balance::Supply<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class Balance<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::balance::Balance<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: BalanceFields<T>) {
    this.$fullTypeName = composeSuiType(
      Balance.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::balance::Balance<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Balance.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::balance::Balance<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
