...
export class Token<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::token::Token<${PhantomToTypeStr<T>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenFields<T>) {
    this.$fullTypeName = composeSuiType(
      Token.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::token::Token<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Token.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::token::Token<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::token::TokenPolicyCap<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyCapFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::token::TokenPolicyCap<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TokenPolicyCap.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::token::TokenPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::token::TokenPolicy<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::token::TokenPolicy<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TokenPolicy.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::token::TokenPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::token::ActionRequest<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ActionRequestFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::token::ActionRequest<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        ActionRequest.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::token::ActionRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::token::RuleKey<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RuleKeyFields<T>) {
    this.$fullTypeName = composeSuiType(
      RuleKey.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::token::RuleKey<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        RuleKey.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::token::RuleKey<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::token::TokenPolicyCreated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenPolicyCreatedFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::token::TokenPolicyCreated<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TokenPolicyCreated.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::token::TokenPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
