...
export class Display<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::display::Display<${PhantomToTypeStr<T>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayFields<T>) {
    this.$fullTypeName = composeSuiType(
      Display.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::display::Display<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Display.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::display::Display<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export class DisplayCreated<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::display::DisplayCreated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DisplayCreatedFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::display::DisplayCreated<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        DisplayCreated.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::display::DisplayCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
...
export class VersionUpdated<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::display::VersionUpdated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: VersionUpdatedFields<T>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::display::VersionUpdated<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        VersionUpdated.$typeName,
        ...[extractType(T)]
      ) as `${typeof PKG_V1}::display::VersionUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>],
