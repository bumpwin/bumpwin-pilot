...
export function isPCREntry(type: string): boolean {
  ...
  return type === `${PKG_V1}::nitro_attestation::PCREntry`;
}
...
export class PCREntry implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::nitro_attestation::PCREntry`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = PCREntry.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::nitro_attestation::PCREntry`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PCREntryFields) {
    this.$fullTypeName = composeSuiType(
      PCREntry.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::nitro_attestation::PCREntry`;
...
export function isNitroAttestationDocument(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::nitro_attestation::NitroAttestationDocument`;
}
...
export class NitroAttestationDocument implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::nitro_attestation::NitroAttestationDocument`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = NitroAttestationDocument.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::nitro_attestation::NitroAttestationDocument`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: NitroAttestationDocumentFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::nitro_attestation::NitroAttestationDocument`;
    this.$typeArgs = typeArgs;
