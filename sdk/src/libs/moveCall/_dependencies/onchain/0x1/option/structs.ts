...
export class Option<T0 extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::option::Option<${ToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<T0>], fields: OptionFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Option.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::option::Option<${ToTypeStr<T0>}>`;
  ...
  static reified<T0 extends Reified<TypeArgument, any>>(T0: T0): OptionReified<ToTypeArgument<T0>> {
    return {
      ...
      fullTypeName: composeSuiType(
        Option.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::option::Option<${ToTypeStr<ToTypeArgument<T0>>}>`,
