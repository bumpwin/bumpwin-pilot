...
export function isFixedPoint32(type: string): boolean {
  ...
  return type === `${PKG_V1}::fixed_point32::FixedPoint32`;
}
...
export class FixedPoint32 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::fixed_point32::FixedPoint32`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = FixedPoint32.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::fixed_point32::FixedPoint32`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: FixedPoint32Fields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::fixed_point32::FixedPoint32`;
