...
export function isString(type: string): boolean {
  ...
  return type === `${PKG_V1}::ascii::String`;
}
...
export class String implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::ascii::String`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = String.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::ascii::String`;
  readonly $typeArgs: [];
  ...
  static reified(): StringReified {
    return {
      ...
      fullTypeName: composeSuiType(String.$typeName, ...[]) as `${typeof PKG_V1}::ascii::String`,
      typeArgs: [] as [],
...
export class Char implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::ascii::Char`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Char.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::ascii::Char`;
  readonly $typeArgs: [];
  ...
  static reified(): CharReified {
    return {
      ...
      fullTypeName: composeSuiType(Char.$typeName, ...[]) as `${typeof PKG_V1}::ascii::Char`,
      typeArgs: [] as [],
