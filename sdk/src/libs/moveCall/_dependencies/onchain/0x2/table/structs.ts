...
export function isTable(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::table::Table` + '<');
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V1}::table::Table`;
  static readonly $numTypeParams = 2;
  static readonly $isPhantom = [true, true] as const;

  readonly $typeName = Table.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::table::Table<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Table.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::table::Table<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  >(T0: T0, T1: T1): TableReified<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
    return {
      ...
      ) as `${typeof PKG_V1}::table::Table<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T1>>}>`,
