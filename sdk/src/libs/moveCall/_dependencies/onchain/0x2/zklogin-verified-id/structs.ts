...
export function isVerifiedID(type: string): boolean {
  ...
  return type === `${PKG_V1}::zklogin_verified_id::VerifiedID`;
}
...
export class VerifiedID implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::zklogin_verified_id::VerifiedID`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = VerifiedID.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::zklogin_verified_id::VerifiedID`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: VerifiedIDFields) {
    this.$fullTypeName = composeSuiType(
      VerifiedID.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::zklogin_verified_id::VerifiedID`;
