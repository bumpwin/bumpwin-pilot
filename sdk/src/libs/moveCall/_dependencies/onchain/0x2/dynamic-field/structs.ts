...
export class Field<T0 extends TypeArgument, T1 extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::dynamic_field::Field<${ToTypeStr<T0>}, ${ToTypeStr<T1>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<T0>, ToTypeStr<T1>], fields: FieldFields<T0, T1>) {
    this.$fullTypeName = composeSuiType(
      Field.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::dynamic_field::Field<${ToTypeStr<T0>}, ${ToTypeStr<T1>}>`;
  ...
  static reified<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      ) as `${typeof PKG_V1}::dynamic_field::Field<${ToTypeStr<ToTypeArgument<T0>>}, ${ToTypeStr<ToTypeArgument<T1>>}>`,
