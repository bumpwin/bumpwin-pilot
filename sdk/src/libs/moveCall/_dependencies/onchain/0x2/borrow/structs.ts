...
export function isReferent(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::borrow::Referent` + '<');
}
...
export class Referent<T0 extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::borrow::Referent`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [false] as const;

  readonly $typeName = Referent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::borrow::Referent<${ToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<T0>], fields: ReferentFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Referent.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::borrow::Referent<${ToTypeStr<T0>}>`;
  ...
  static reified<T0 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Referent.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::borrow::Referent<${ToTypeStr<ToTypeArgument<T0>>}>`,
...
export function isBorrow(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::borrow::Borrow`;
}
...
export class Borrow implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::borrow::Borrow`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Borrow.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::borrow::Borrow`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: BorrowFields) {
    this.$fullTypeName = composeSuiType(
      Borrow.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::borrow::Borrow`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): BorrowReified {
    return {
      ...
      fullTypeName: composeSuiType(Borrow.$typeName, ...[]) as `${typeof PKG_V1}::borrow::Borrow`,
      typeArgs: [] as [],
