...
export class TableVec<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::table_vec::TableVec<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TableVecFields<T0>) {
    this.$fullTypeName = composeSuiType(
      TableVec.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::table_vec::TableVec<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TableVec.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::table_vec::TableVec<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
