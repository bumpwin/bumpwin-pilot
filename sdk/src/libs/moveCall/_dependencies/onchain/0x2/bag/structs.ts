...
export class Bag implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bag::Bag`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Bag.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bag::Bag`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: BagFields) {
    this.$fullTypeName = composeSuiType(Bag.$typeName, ...typeArgs) as `${typeof PKG_V1}::bag::Bag`;
  ...
  static reified(): BagReified {
    return {
      ...
      fullTypeName: composeSuiType(Bag.$typeName, ...[]) as `${typeof PKG_V1}::bag::Bag`,
      typeArgs: [] as [],
