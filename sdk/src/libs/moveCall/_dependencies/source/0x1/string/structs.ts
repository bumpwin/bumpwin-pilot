...
export function isString(type: string): boolean {
  ...
  return type === `${PKG_V1}::string::String`;
}
...
export class String implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::string::String`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = String.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::string::String`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: StringFields) {
    this.$fullTypeName = composeSuiType(
      String.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::string::String`;
  ...
  static reified(): StringReified {
    return {
      ...
      fullTypeName: composeSuiType(String.$typeName, ...[]) as `${typeof PKG_V1}::string::String`,
      typeArgs: [] as [],
