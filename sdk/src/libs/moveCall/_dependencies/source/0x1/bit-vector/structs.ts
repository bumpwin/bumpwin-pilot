...
export function isBitVector(type: string): boolean {
  ...
  return type === `${PKG_V1}::bit_vector::BitVector`;
}
...
export class BitVector implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bit_vector::BitVector`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = BitVector.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bit_vector::BitVector`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: BitVectorFields) {
    this.$fullTypeName = composeSuiType(
      BitVector.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::bit_vector::BitVector`;
