...
export function isUQ64_64(type: string): boolean {
  ...
  return type === `${PKG_V1}::uq64_64::UQ64_64`;
}
...
export class UQ64_64 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::uq64_64::UQ64_64`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UQ64_64.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::uq64_64::UQ64_64`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UQ64_64Fields) {
    this.$fullTypeName = composeSuiType(
      UQ64_64.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::uq64_64::UQ64_64`;
