...
export function isField(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::dynamic_field::Field` + '<');
}
...
export class Field<Name extends TypeArgument, Value extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::dynamic_field::Field`;
  static readonly $numTypeParams = 2;
  static readonly $isPhantom = [false, false] as const;

  readonly $typeName = Field.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::dynamic_field::Field<${ToTypeStr<Name>}, ${ToTypeStr<Value>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Field.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::dynamic_field::Field<${ToTypeStr<Name>}, ${ToTypeStr<Value>}>`;
  ...
  static reified<Name extends Reified<TypeArgument, any>, Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      ) as `${typeof PKG_V1}::dynamic_field::Field<${ToTypeStr<ToTypeArgument<Name>>}, ${ToTypeStr<ToTypeArgument<Value>>}>`,
