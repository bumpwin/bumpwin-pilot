...
export function isAuthenticatorState(type: string): boolean {
  ...
  return type === `${PKG_V1}::authenticator_state::AuthenticatorState`;
}
...
export class AuthenticatorState implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::authenticator_state::AuthenticatorState`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = AuthenticatorState.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::authenticator_state::AuthenticatorState`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: AuthenticatorStateFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::authenticator_state::AuthenticatorState`;
...
export function isAuthenticatorStateInner(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::authenticator_state::AuthenticatorStateInner`;
}
...
export class AuthenticatorStateInner implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::authenticator_state::AuthenticatorStateInner`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = AuthenticatorStateInner.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::authenticator_state::AuthenticatorStateInner`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: AuthenticatorStateInnerFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::authenticator_state::AuthenticatorStateInner`;
    this.$typeArgs = typeArgs;
...
export function isJWK(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::authenticator_state::JWK`;
}
...
export class JWK implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::authenticator_state::JWK`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = JWK.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::authenticator_state::JWK`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: JWKFields) {
    this.$fullTypeName = composeSuiType(
      JWK.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::authenticator_state::JWK`;
    this.$typeArgs = typeArgs;
...
export function isJwkId(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::authenticator_state::JwkId`;
}
...
export class JwkId implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::authenticator_state::JwkId`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = JwkId.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::authenticator_state::JwkId`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: JwkIdFields) {
    this.$fullTypeName = composeSuiType(
      JwkId.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::authenticator_state::JwkId`;
    this.$typeArgs = typeArgs;
...
export function isActiveJwk(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::authenticator_state::ActiveJwk`;
}
...
export class ActiveJwk implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::authenticator_state::ActiveJwk`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ActiveJwk.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::authenticator_state::ActiveJwk`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ActiveJwkFields) {
    this.$fullTypeName = composeSuiType(
      ActiveJwk.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::authenticator_state::ActiveJwk`;
    this.$typeArgs = typeArgs;
