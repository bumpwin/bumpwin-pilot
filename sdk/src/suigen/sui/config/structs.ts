...
export function isConfig(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::config::Config` + '<');
}
...
export class Config<WriteCap extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::config::Config`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Config.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::config::Config<${PhantomToTypeStr<WriteCap>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<WriteCap>], fields: ConfigFields<WriteCap>) {
    this.$fullTypeName = composeSuiType(
      Config.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::config::Config<${PhantomToTypeStr<WriteCap>}>`;
  ...
  static reified<WriteCap extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      ) as `${typeof PKG_V1}::config::Config<${PhantomToTypeStr<ToPhantomTypeArgument<WriteCap>>}>`,
...
export function isSetting(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::config::Setting` + '<');
}
...
export class Setting<Value extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::config::Setting`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [false] as const;

  readonly $typeName = Setting.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::config::Setting<${ToTypeStr<Value>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<Value>], fields: SettingFields<Value>) {
    this.$fullTypeName = composeSuiType(
      Setting.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::config::Setting<${ToTypeStr<Value>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Setting.$typeName,
        ...[extractType(Value)]
      ) as `${typeof PKG_V1}::config::Setting<${ToTypeStr<ToTypeArgument<Value>>}>`,
...
export function isSettingData(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::config::SettingData` + '<');
}
...
export class SettingData<Value extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::config::SettingData`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [false] as const;

  readonly $typeName = SettingData.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::config::SettingData<${ToTypeStr<Value>}>`;
  readonly $typeArgs: [ToTypeStr<Value>];
  ...
  private constructor(typeArgs: [ToTypeStr<Value>], fields: SettingDataFields<Value>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::config::SettingData<${ToTypeStr<Value>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        SettingData.$typeName,
        ...[extractType(Value)]
      ) as `${typeof PKG_V1}::config::SettingData<${ToTypeStr<ToTypeArgument<Value>>}>`,
      typeArgs: [extractType(Value)] as [ToTypeStr<ToTypeArgument<Value>>],
