...
export class Config<WriteCap extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V29}::config::Config<${PhantomToTypeStr<WriteCap>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<WriteCap>], fields: ConfigFields<WriteCap>) {
    this.$fullTypeName = composeSuiType(
      Config.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V29}::config::Config<${PhantomToTypeStr<WriteCap>}>`;
  ...
  static reified<WriteCap extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      ) as `${typeof PKG_V29}::config::Config<${PhantomToTypeStr<ToPhantomTypeArgument<WriteCap>>}>`,
...
export class Setting<Value extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V29}::config::Setting<${ToTypeStr<Value>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<Value>], fields: SettingFields<Value>) {
    this.$fullTypeName = composeSuiType(
      Setting.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V29}::config::Setting<${ToTypeStr<Value>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Setting.$typeName,
        ...[extractType(Value)]
      ) as `${typeof PKG_V29}::config::Setting<${ToTypeStr<ToTypeArgument<Value>>}>`,
...
export class SettingData<Value extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V29}::config::SettingData<${ToTypeStr<Value>}>`;
  readonly $typeArgs: [ToTypeStr<Value>];
  ...
  private constructor(typeArgs: [ToTypeStr<Value>], fields: SettingDataFields<Value>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V29}::config::SettingData<${ToTypeStr<Value>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        SettingData.$typeName,
        ...[extractType(Value)]
      ) as `${typeof PKG_V29}::config::SettingData<${ToTypeStr<ToTypeArgument<Value>>}>`,
      typeArgs: [extractType(Value)] as [ToTypeStr<ToTypeArgument<Value>>],
