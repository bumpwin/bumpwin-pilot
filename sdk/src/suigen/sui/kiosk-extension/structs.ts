...
export function isExtension(type: string): boolean {
  ...
  return type === `${PKG_V1}::kiosk_extension::Extension`;
}
...
export class Extension implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::kiosk_extension::Extension`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Extension.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::kiosk_extension::Extension`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ExtensionFields) {
    this.$fullTypeName = composeSuiType(
      Extension.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::kiosk_extension::Extension`;
...
export function isExtensionKey(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::kiosk_extension::ExtensionKey` + '<');
}
...
export class ExtensionKey<Ext extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::kiosk_extension::ExtensionKey`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = ExtensionKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<Ext>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<Ext>], fields: ExtensionKeyFields<Ext>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<Ext>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<Ext extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        ExtensionKey.$typeName,
        ...[extractType(Ext)]
      ) as `${typeof PKG_V1}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<ToPhantomTypeArgument<Ext>>}>`,
