...
export function new_(tx: Transaction, bytes: Array<number | TransactionArgument> | TransactionArgument) {
  return tx.moveCall({ target: `${PUBLISHED_AT}::bcs::new`, arguments: [pure(tx, bytes, `vector<u8>`)] });
}

export function intoRemainderBytes(tx: Transaction, bcs: TransactionObjectInput) {
  return tx.moveCall({ target: `${PUBLISHED_AT}::bcs::into_remainder_bytes`, arguments: [obj(tx, bcs)] });
}
...
export function peelVecAddress(tx: Transaction, bcs: TransactionObjectInput) {
  return tx.moveCall({ target: `${PUBLISHED_AT}::bcs::peel_vec_address`, arguments: [obj(tx, bcs)] });
}
...
export function peelOptionAddress(tx: Transaction, bcs: TransactionObjectInput) {
  return tx.moveCall({ target: `${PUBLISHED_AT}::bcs::peel_option_address`, arguments: [obj(tx, bcs)] });
}

export function peelOptionBool(tx: Transaction, bcs: TransactionObjectInput) {
  return tx.moveCall({ target: `${PUBLISHED_AT}::bcs::peel_option_bool`, arguments: [obj(tx, bcs)] });
}
...
export function peelOptionU128(tx: Transaction, bcs: TransactionObjectInput) {
  return tx.moveCall({ target: `${PUBLISHED_AT}::bcs::peel_option_u128`, arguments: [obj(tx, bcs)] });
}

export function peelOptionU256(tx: Transaction, bcs: TransactionObjectInput) {
  return tx.moveCall({ target: `${PUBLISHED_AT}::bcs::peel_option_u256`, arguments: [obj(tx, bcs)] });
}
