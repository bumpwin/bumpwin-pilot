...
export function isPublisher(type: string): boolean {
  ...
  return type === `${PKG_V1}::package::Publisher`;
}
...
export class Publisher implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::package::Publisher`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Publisher.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::package::Publisher`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PublisherFields) {
    this.$fullTypeName = composeSuiType(
      Publisher.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::package::Publisher`;
...
export function isUpgradeCap(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::package::UpgradeCap`;
}
...
export class UpgradeCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::package::UpgradeCap`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UpgradeCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::package::UpgradeCap`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UpgradeCapFields) {
    this.$fullTypeName = composeSuiType(
      UpgradeCap.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::package::UpgradeCap`;
    this.$typeArgs = typeArgs;
...
export function isUpgradeTicket(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::package::UpgradeTicket`;
}
...
export class UpgradeTicket implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::package::UpgradeTicket`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UpgradeTicket.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::package::UpgradeTicket`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UpgradeTicketFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::package::UpgradeTicket`;
    this.$typeArgs = typeArgs;
...
export function isUpgradeReceipt(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::package::UpgradeReceipt`;
}
...
export class UpgradeReceipt implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::package::UpgradeReceipt`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UpgradeReceipt.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::package::UpgradeReceipt`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UpgradeReceiptFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::package::UpgradeReceipt`;
    this.$typeArgs = typeArgs;
