...
export function isPCREntry(type: string): boolean {
  ...
  return type === `${PKG_V30}::nitro_attestation::PCREntry`;
}
...
export class PCREntry implements StructClass {
  ...
  static readonly $typeName = `${PKG_V30}::nitro_attestation::PCREntry`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = PCREntry.$typeName;
  readonly $fullTypeName: `${typeof PKG_V30}::nitro_attestation::PCREntry`;
  readonly $typeArgs: [];
...
export function isNitroAttestationDocument(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V30}::nitro_attestation::NitroAttestationDocument`;
}
...
export class NitroAttestationDocument implements StructClass {
  ...
  static readonly $typeName = `${PKG_V30}::nitro_attestation::NitroAttestationDocument`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = NitroAttestationDocument.$typeName;
  readonly $fullTypeName: `${typeof PKG_V30}::nitro_attestation::NitroAttestationDocument`;
  readonly $typeArgs: [];
