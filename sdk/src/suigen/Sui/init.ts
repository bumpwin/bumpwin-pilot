import * as authenticatorState from "./authenticator_state/structs";
...
import * as denyList from "./deny_list/structs";
import * as display from "./display/structs";
import * as dynamicField from "./dynamic_field/structs";
import * as dynamicObjectField from "./dynamic_object_field/structs";
import * as groth16 from "./groth16/structs";
import * as groupOps from "./group_ops/structs";
import * as kiosk from "./kiosk/structs";
import * as kioskExtension from "./kiosk_extension/structs";
import * as linkedTable from "./linked_table/structs";
import * as nitroAttestation from "./nitro_attestation/structs";
import * as object from "./object/structs";
import * as objectBag from "./object_bag/structs";
import * as objectTable from "./object_table/structs";
import * as package_ from "./package/structs";
import * as priorityQueue from "./priority_queue/structs";
import * as random from "./random/structs";
import * as sui from "./sui/structs";
import * as table from "./table/structs";
import * as tableVec from "./table_vec/structs";
import * as token from "./token/structs";
import * as transfer from "./transfer/structs";
import * as transferPolicy from "./transfer_policy/structs";
import * as txContext from "./tx_context/structs";
import * as url from "./url/structs";
import * as vecMap from "./vec_map/structs";
import * as vecSet from "./vec_set/structs";
import * as versioned from "./versioned/structs";
import * as zkloginVerifiedId from "./zklogin_verified_id/structs";
import * as zkloginVerifiedIssuer from "./zklogin_verified_issuer/structs";
