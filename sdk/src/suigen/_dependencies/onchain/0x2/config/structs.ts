...
export class Config<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::config::Config<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ConfigFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Config.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::config::Config<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Config.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::config::Config<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
...
export class Setting<T0 extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::config::Setting<${ToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<T0>], fields: SettingFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Setting.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::config::Setting<${ToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Setting.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::config::Setting<${ToTypeStr<ToTypeArgument<T0>>}>`,
...
export class SettingData<T0 extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::config::SettingData<${ToTypeStr<T0>}>`;
  readonly $typeArgs: [ToTypeStr<T0>];
  ...
  private constructor(typeArgs: [ToTypeStr<T0>], fields: SettingDataFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::config::SettingData<${ToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        SettingData.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::config::SettingData<${ToTypeStr<ToTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [ToTypeStr<ToTypeArgument<T0>>],
