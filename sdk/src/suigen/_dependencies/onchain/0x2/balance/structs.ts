...
export function isSupply(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::balance::Supply` + '<');
}
...
export class Supply<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::balance::Supply`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Supply.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::balance::Supply<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: SupplyFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Supply.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::balance::Supply<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Supply.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::balance::Supply<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
...
export function isBalance(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::balance::Balance` + '<');
}
...
export class Balance<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::balance::Balance`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Balance.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::balance::Balance<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: BalanceFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Balance.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::balance::Balance<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Balance.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::balance::Balance<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
