...
export class Url implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::url::Url`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Url.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::url::Url`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UrlFields) {
    this.$fullTypeName = composeSuiType(Url.$typeName, ...typeArgs) as `${typeof PKG_V1}::url::Url`;
  ...
  static reified(): UrlReified {
    return {
      ...
      fullTypeName: composeSuiType(Url.$typeName, ...[]) as `${typeof PKG_V1}::url::Url`,
      typeArgs: [] as [],
