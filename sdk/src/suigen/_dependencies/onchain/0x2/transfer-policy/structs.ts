...
export function isTransferRequest(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::transfer_policy::TransferRequest` + '<');
}
...
export class TransferRequest<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::transfer_policy::TransferRequest`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferRequest.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferRequest<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferRequestFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferRequest<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferRequest.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
...
export function isTransferPolicy(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::transfer_policy::TransferPolicy` + '<');
}
...
export class TransferPolicy<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::transfer_policy::TransferPolicy`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferPolicy.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicy<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicy.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
...
export function isTransferPolicyCap(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::transfer_policy::TransferPolicyCap` + '<');
}
...
export class TransferPolicyCap<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::transfer_policy::TransferPolicyCap`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferPolicyCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyCapFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicyCap.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
...
export function isTransferPolicyCreated(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::transfer_policy::TransferPolicyCreated` + '<');
}
...
export class TransferPolicyCreated<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::transfer_policy::TransferPolicyCreated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferPolicyCreated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyCreatedFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicyCreated.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
...
export function isTransferPolicyDestroyed(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::transfer_policy::TransferPolicyDestroyed` + '<');
}
...
export class TransferPolicyDestroyed<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::transfer_policy::TransferPolicyDestroyed`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = TransferPolicyDestroyed.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyDestroyedFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TransferPolicyDestroyed.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
...
export function isRuleKey(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::transfer_policy::RuleKey` + '<');
}
...
export class RuleKey<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::transfer_policy::RuleKey`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = RuleKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::transfer_policy::RuleKey<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: RuleKeyFields<T0>) {
    this.$fullTypeName = composeSuiType(
      RuleKey.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer_policy::RuleKey<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        RuleKey.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::transfer_policy::RuleKey<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
