...
export class TransferPolicyCap<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCap.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCap.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) => TransferPolicyCap.fromSuiObjectData(T0, content),
...
export class TransferPolicyCreated<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCreated.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCreated.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) => TransferPolicyCreated.fromSuiObjectData(T0, content),
...
export class TransferPolicyDestroyed<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyDestroyed.fromFieldsWithTypes(T0, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) => TransferPolicyDestroyed.fromSuiParsedData(T0, content),
      fromSuiObjectData: (content: SuiObjectData) => TransferPolicyDestroyed.fromSuiObjectData(T0, content),
...
export class RuleKey<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(T0: T0): RuleKeyReified<ToPhantomTypeArgument<T0>> {
    return {
