...
export class LinkedTable<T0 extends TypeArgument, T1 extends PhantomTypeArgument> implements StructClass {
  ...
  private constructor(typeArgs: [ToTypeStr<T0>, PhantomToTypeStr<T1>], fields: LinkedTableFields<T0, T1>) {
  ...
  static reified<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0,
    T1: T1,
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) => LinkedTable.fromFieldsWithTypes([T0, T1], item),
      ...
      fromSuiParsedData: (content: SuiParsedData) => LinkedTable.fromSuiParsedData([T0, T1], content),
      fromSuiObjectData: (content: SuiObjectData) => LinkedTable.fromSuiObjectData([T0, T1], content),
  ...
  static phantom<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    T0: T0,
    T1: T1,
  ...
  static fromFields<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    typeArgs: [T0, T1],
  ...
  static fromFieldsWithTypes<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    typeArgs: [T0, T1],
  ...
  static fromBcs<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    typeArgs: [T0, T1],
    data: Uint8Array,
  ): LinkedTable<ToTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
  ...
  static fromJSONField<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    typeArgs: [T0, T1],
    field: any,
  ): LinkedTable<ToTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
    return LinkedTable.reified(typeArgs[0], typeArgs[1]).new({
  ...
  static fromJSON<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    typeArgs: [T0, T1],
  ...
  static fromSuiParsedData<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    typeArgs: [T0, T1],
  ...
  static fromSuiObjectData<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    typeArgs: [T0, T1],
    data: SuiObjectData,
  ): LinkedTable<ToTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
    if (data.bcs) {
  ...
  static async fetch<T0 extends Reified<TypeArgument, any>, T1 extends PhantomReified<PhantomTypeArgument>>(
    client: SuiClient,
    typeArgs: [T0, T1],
    id: string,
...
export class Node<T0 extends TypeArgument, T1 extends TypeArgument> implements StructClass {
  ...
  static reified<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      typeArgs: [extractType(T0), extractType(T1)] as [ToTypeStr<ToTypeArgument<T0>>, ToTypeStr<ToTypeArgument<T1>>],
  ...
  static fromFieldsWithTypes<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>>(
    typeArgs: [T0, T1],
    item: FieldsWithTypes,
  ): Node<ToTypeArgument<T0>, ToTypeArgument<T1>> {
    if (!isNode(item.type)) {
  ...
  static fromJSONField<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>>(
    typeArgs: [T0, T1],
    field: any,
  ): Node<ToTypeArgument<T0>, ToTypeArgument<T1>> {
    return Node.reified(typeArgs[0], typeArgs[1]).new({
  ...
  static fromSuiParsedData<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>>(
    typeArgs: [T0, T1],
    content: SuiParsedData,
  ): Node<ToTypeArgument<T0>, ToTypeArgument<T1>> {
    if (content.dataType !== 'moveObject') {
  ...
  static fromSuiObjectData<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>>(
    typeArgs: [T0, T1],
    data: SuiObjectData,
  ): Node<ToTypeArgument<T0>, ToTypeArgument<T1>> {
    if (data.bcs) {
