...
export function isObjectTable(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::object_table::ObjectTable` + '<');
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V1}::object_table::ObjectTable`;
  static readonly $numTypeParams = 2;
  static readonly $isPhantom = [true, true] as const;

  readonly $typeName = ObjectTable.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::object_table::ObjectTable<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::object_table::ObjectTable<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  >(T0: T0, T1: T1): ObjectTableReified<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
    return {
      ...
      ) as `${typeof PKG_V1}::object_table::ObjectTable<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T1>>}>`,
