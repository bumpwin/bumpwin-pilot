...
export function isElement(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::group_ops::Element` + '<');
}
...
export class Element<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::group_ops::Element`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Element.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::group_ops::Element<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ElementFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Element.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::group_ops::Element<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Element.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::group_ops::Element<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
