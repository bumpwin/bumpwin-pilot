...
export class Wrapper<T0 extends TypeArgument> implements StructClass {
  ...
  readonly $fullTypeName: `${typeof PKG_V1}::dynamic_object_field::Wrapper<${ToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [ToTypeStr<T0>], fields: WrapperFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Wrapper.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::dynamic_object_field::Wrapper<${ToTypeStr<T0>}>`;
  ...
  static reified<T0 extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Wrapper.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::dynamic_object_field::Wrapper<${ToTypeStr<ToTypeArgument<T0>>}>`,
