...
export function isScalar(type: string): boolean {
  ...
  return type === `${PKG_V1}::bls12381::Scalar`;
}
...
export class Scalar implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bls12381::Scalar`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Scalar.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bls12381::Scalar`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ScalarFields) {
    this.$fullTypeName = composeSuiType(
      Scalar.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::bls12381::Scalar`;
  ...
  static reified(): ScalarReified {
    return {
      ...
      fullTypeName: composeSuiType(Scalar.$typeName, ...[]) as `${typeof PKG_V1}::bls12381::Scalar`,
      typeArgs: [] as [],
...
export function isG1(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::bls12381::G1`;
}
...
export class G1 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bls12381::G1`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = G1.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bls12381::G1`;
  readonly $typeArgs: [];
  ...
  static reified(): G1Reified {
    return {
      ...
      fullTypeName: composeSuiType(G1.$typeName, ...[]) as `${typeof PKG_V1}::bls12381::G1`,
      typeArgs: [] as [],
...
export function isG2(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::bls12381::G2`;
}
...
export class G2 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bls12381::G2`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = G2.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bls12381::G2`;
  readonly $typeArgs: [];
  ...
  static reified(): G2Reified {
    return {
      ...
      fullTypeName: composeSuiType(G2.$typeName, ...[]) as `${typeof PKG_V1}::bls12381::G2`,
      typeArgs: [] as [],
...
export function isGT(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::bls12381::GT`;
}
...
export class GT implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bls12381::GT`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = GT.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bls12381::GT`;
  readonly $typeArgs: [];
  ...
  static reified(): GTReified {
    return {
      ...
      fullTypeName: composeSuiType(GT.$typeName, ...[]) as `${typeof PKG_V1}::bls12381::GT`,
      typeArgs: [] as [],
...
export function isUncompressedG1(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::bls12381::UncompressedG1`;
}
...
export class UncompressedG1 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bls12381::UncompressedG1`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UncompressedG1.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bls12381::UncompressedG1`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UncompressedG1Fields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::bls12381::UncompressedG1`;
    this.$typeArgs = typeArgs;
