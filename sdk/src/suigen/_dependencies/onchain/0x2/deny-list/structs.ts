...
export function isDenyList(type: string): boolean {
  ...
  return type === `${PKG_V1}::deny_list::DenyList`;
}
...
export class DenyList implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::deny_list::DenyList`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = DenyList.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::deny_list::DenyList`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: DenyListFields) {
    this.$fullTypeName = composeSuiType(
      DenyList.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::deny_list::DenyList`;
...
export function isConfigWriteCap(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::deny_list::ConfigWriteCap`;
}
...
export class ConfigWriteCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::deny_list::ConfigWriteCap`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ConfigWriteCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::deny_list::ConfigWriteCap`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ConfigWriteCapFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::deny_list::ConfigWriteCap`;
    this.$typeArgs = typeArgs;
...
export function isConfigKey(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::deny_list::ConfigKey`;
}
...
export class ConfigKey implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::deny_list::ConfigKey`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ConfigKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::deny_list::ConfigKey`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ConfigKeyFields) {
    this.$fullTypeName = composeSuiType(
      ConfigKey.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::deny_list::ConfigKey`;
    this.$typeArgs = typeArgs;
...
export function isAddressKey(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::deny_list::AddressKey`;
}
...
export class AddressKey implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::deny_list::AddressKey`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = AddressKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::deny_list::AddressKey`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: AddressKeyFields) {
    this.$fullTypeName = composeSuiType(
      AddressKey.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::deny_list::AddressKey`;
    this.$typeArgs = typeArgs;
...
export function isGlobalPauseKey(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::deny_list::GlobalPauseKey`;
}
...
export class GlobalPauseKey implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::deny_list::GlobalPauseKey`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = GlobalPauseKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::deny_list::GlobalPauseKey`;
  readonly $typeArgs: [];
...
export function isPerTypeConfigCreated(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::deny_list::PerTypeConfigCreated`;
}
...
export class PerTypeConfigCreated implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::deny_list::PerTypeConfigCreated`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = PerTypeConfigCreated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::deny_list::PerTypeConfigCreated`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PerTypeConfigCreatedFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::deny_list::PerTypeConfigCreated`;
    this.$typeArgs = typeArgs;
...
export function isPerTypeList(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::deny_list::PerTypeList`;
}
...
export class PerTypeList implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::deny_list::PerTypeList`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = PerTypeList.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::deny_list::PerTypeList`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PerTypeListFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::deny_list::PerTypeList`;
    this.$typeArgs = typeArgs;
