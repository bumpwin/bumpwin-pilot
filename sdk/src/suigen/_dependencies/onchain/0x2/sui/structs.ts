...
export class SUI implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::sui::SUI`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SUI.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::sui::SUI`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: SUIFields) {
    this.$fullTypeName = composeSuiType(SUI.$typeName, ...typeArgs) as `${typeof PKG_V1}::sui::SUI`;
  ...
  static reified(): SUIReified {
    return {
      ...
      fullTypeName: composeSuiType(SUI.$typeName, ...[]) as `${typeof PKG_V1}::sui::SUI`,
      typeArgs: [] as [],
