...
export function isDisplay(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::display::Display` + '<');
}
...
export class Display<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::display::Display`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Display.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::display::Display<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: DisplayFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Display.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::display::Display<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Display.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::display::Display<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
...
export function isDisplayCreated(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::display::DisplayCreated` + '<');
}
...
export class DisplayCreated<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::display::DisplayCreated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = DisplayCreated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::display::DisplayCreated<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: DisplayCreatedFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::display::DisplayCreated<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        DisplayCreated.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::display::DisplayCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
...
export function isVersionUpdated(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::display::VersionUpdated` + '<');
}
...
export class VersionUpdated<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::display::VersionUpdated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = VersionUpdated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::display::VersionUpdated<${PhantomToTypeStr<T0>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T0>];
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: VersionUpdatedFields<T0>) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs
    ) as `${typeof PKG_V1}::display::VersionUpdated<${PhantomToTypeStr<T0>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        VersionUpdated.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::display::VersionUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
      typeArgs: [extractType(T0)] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>],
