...
export class BCS implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::bcs::BCS`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = BCS.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::bcs::BCS`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: BCSFields) {
    this.$fullTypeName = composeSuiType(BCS.$typeName, ...typeArgs) as `${typeof PKG_V1}::bcs::BCS`;
  ...
  static reified(): BCSReified {
    return {
      ...
      fullTypeName: composeSuiType(BCS.$typeName, ...[]) as `${typeof PKG_V1}::bcs::BCS`,
      typeArgs: [] as [],
