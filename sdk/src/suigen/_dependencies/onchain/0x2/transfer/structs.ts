...
export function isReceiving(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::transfer::Receiving` + '<');
}
...
export class Receiving<T0 extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::transfer::Receiving`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Receiving.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::transfer::Receiving<${PhantomToTypeStr<T0>}>`;
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ReceivingFields<T0>) {
    this.$fullTypeName = composeSuiType(
      Receiving.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::transfer::Receiving<${PhantomToTypeStr<T0>}>`;
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Receiving.$typeName,
        ...[extractType(T0)]
      ) as `${typeof PKG_V1}::transfer::Receiving<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`,
