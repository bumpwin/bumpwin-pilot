...
export type ObjectTableReified<T0 extends PhantomTypeArgument, T1 extends PhantomTypeArgument> = Reified<
  ObjectTable<T0, T1>,
  ObjectTableFields<T0, T1>
>;

export class ObjectTable<T0 extends PhantomTypeArgument, T1 extends PhantomTypeArgument> implements StructClass {
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T0>, PhantomToTypeStr<T1>], fields: ObjectTableFields<T0, T1>) {
  ...
  static reified<T0 extends PhantomReified<PhantomTypeArgument>, T1 extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) => ObjectTable.fromFieldsWithTypes([T0, T1], item),
      ...
      fromSuiParsedData: (content: SuiParsedData) => ObjectTable.fromSuiParsedData([T0, T1], content),
      fromSuiObjectData: (content: SuiObjectData) => ObjectTable.fromSuiObjectData([T0, T1], content),
  ...
  >(typeArgs: [T0, T1], item: FieldsWithTypes): ObjectTable<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
  ...
  static fromSuiParsedData<
    T0 extends PhantomReified<PhantomTypeArgument>,
    T1 extends PhantomReified<PhantomTypeArgument>,
  >(typeArgs: [T0, T1], content: SuiParsedData): ObjectTable<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
  ...
  static fromSuiObjectData<
    T0 extends PhantomReified<PhantomTypeArgument>,
    T1 extends PhantomReified<PhantomTypeArgument>,
  >(typeArgs: [T0, T1], data: SuiObjectData): ObjectTable<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
    if (data.bcs) {
