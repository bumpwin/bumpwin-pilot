...
export function isString(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::ascii::String`; }
...
export class String implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::ascii::String`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = String.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::ascii::String`; readonly $typeArgs: []; readonly $isPhantom = String.$isPhantom;

 readonly bytes: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: StringFields, ) { this.$fullTypeName = composeSuiType( String.$typeName, ...typeArgs ) as `${typeof PKG_V16}::ascii::String`; this.$typeArgs = typeArgs;

 this.bytes = fields.bytes; }

 static reified( ): StringReified { return { typeName: String.$typeName, fullTypeName: composeSuiType( String.$typeName, ...[] ) as `${typeof PKG_V16}::ascii::String`, typeArgs: [ ] as [], isPhantom: String.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => String.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => String.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => String.fromBcs( data, ), bcs: String.bcs, fromJSONField: (field: any) => String.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => String.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => String.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => String.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => String.fetch( client, id, ), new: ( fields: StringFields, ) => { return new String( [], fields ) }, kind: "StructClassReified", } }
...
export function isChar(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::ascii::Char`; }
...
export class Char implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::ascii::Char`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Char.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::ascii::Char`; readonly $typeArgs: []; readonly $isPhantom = Char.$isPhantom;

 readonly byte: ToField<"u8">

 private constructor(typeArgs: [], fields: CharFields, ) { this.$fullTypeName = composeSuiType( Char.$typeName, ...typeArgs ) as `${typeof PKG_V16}::ascii::Char`; this.$typeArgs = typeArgs;

 this.byte = fields.byte; }

 static reified( ): CharReified { return { typeName: Char.$typeName, fullTypeName: composeSuiType( Char.$typeName, ...[] ) as `${typeof PKG_V16}::ascii::Char`, typeArgs: [ ] as [], isPhantom: Char.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Char.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Char.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Char.fromBcs( data, ), bcs: Char.bcs, fromJSONField: (field: any) => Char.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Char.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Char.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Char.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Char.fetch( client, id, ), new: ( fields: CharFields, ) => { return new Char( [], fields ) }, kind: "StructClassReified", } }
