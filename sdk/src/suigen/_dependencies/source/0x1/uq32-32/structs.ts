...
export function isUQ32_32(type: string): boolean {
  ...
  return type === `${PKG_V1}::uq32_32::UQ32_32`;
}
...
export class UQ32_32 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::uq32_32::UQ32_32`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UQ32_32.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::uq32_32::UQ32_32`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UQ32_32Fields) {
    this.$fullTypeName = composeSuiType(
      UQ32_32.$typeName,
      ...typeArgs
    ) as `${typeof PKG_V1}::uq32_32::UQ32_32`;
