...
export const editableCoinMetadata: EditableCoinMetadataFields[] = [
  {
    "name": "Aqualien",
    "symbol": "AQLN",
    "description": "An interdimensional aquatic lifeform believed to cause flash rugpulls whenever observed. Possibly sentient liquidity.",
    "iconUrl": "https://res.cloudinary.com/demo/image/upload/v1714900000/sample.jpg"
  },
  {
    "name": "BlowFi",
    "symbol": "BLWF",
    "description": "A pufferfish-shaped DeFi protocol that inflates yield—and risk. Handle with care. May explode on-chain.",
    "iconUrl": "https://res.cloudinary.com/demo/image/upload/v1714900001/sample.jpg"
  },
  {
    "name": "ClutchSquid",
    "symbol": "CLSQ",
    "description": "An angry purple squid that believes it's the MVP of every memecoin showdown. Always misses the entry.",
  ...
  },
  {
    "name": "Moistie",
    "symbol": "MST",
    "description": "A coelacanth-style relic for ancient holders. Still alive. Still underwater. Still waiting to break even.",
  ...
  },
  {
    "name": "SniffDAO",
    "symbol": "SNIF",
    "description": "A DAO powered by Beagle-grade alpha detection. Sniffs out trends before they trend—or before they die.",
